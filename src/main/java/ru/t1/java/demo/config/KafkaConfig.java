...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, Account> accountConsumerFactory() {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.example.kafka.model.Account");
...
//    @Bean("account")
//    public KafkaTemplate<String, Account> kafkaTemplateAccount(ProducerFactory<String, Account> producerFactory) {
//        return new KafkaTemplate<>(producerFactory);
//    }
//
//    @Bean("transaction")
//    public KafkaTemplate<String, Transaction> kafkaTemplateTransaction(ProducerFactory<String, Transaction> producerFactory) {
//        return new KafkaTemplate<>(producerFactory);
//    }
